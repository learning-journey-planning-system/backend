...
class CRUDJobRoleSkill(CRUDBase[JobRoleSkill, JobRoleSkillCreate, JobRoleSkillUpdate]):
    ...
    def get_jobroleskills_by_jobrole_id(self, db: Session, *, jobrole_id: int) -> List[JobRoleSkill]:
        return db.query(self.model).filter(self.model.jobrole_id == jobrole_id).all()
